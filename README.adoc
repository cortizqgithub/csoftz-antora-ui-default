...
[NOTE
====
The contents are slightly modified from the Antora Default UI (https://gitlab.com/antora/antora-ui-default)
for my own purpose, even tough I preserve this README that may be useful for reference purposes.

This is not a fork of the site. It is initially downloaded as ZIP and contents created to this repo.
====
